...
export default class UsersPermissions extends React.Component<IUsersPermissionsProps, {}> {
  public render(): React.ReactElement<IUsersPermissionsProps> {
    ...
    return (
      <section className={`${styles.usersPermissions} ${hasTeamsContext ? styles.teams : ''}`}>
